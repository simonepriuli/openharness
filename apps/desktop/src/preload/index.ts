...
const harness: HarnessAPI = {
  ...
  getLinearStatus: () => ipcRenderer.invoke("harness:getLinearStatus"),
  openLinearConnect: () => ipcRenderer.invoke("harness:openLinearConnect"),
  deleteLinearInstallation: () => ipcRenderer.invoke("harness:deleteLinearInstallation"),
  listLinearMappings: () => ipcRenderer.invoke("harness:listLinearMappings"),
  listLinearProjects: () => ipcRenderer.invoke("harness:listLinearProjects"),
  upsertLinearMapping: (options) => ipcRenderer.invoke("harness:upsertLinearMapping", options),
  ...
  getOrgSecrets: () => ipcRenderer.invoke("harness:getOrgSecrets"),
  upsertOrgSecret: (options) => ipcRenderer.invoke("harness:upsertOrgSecret", options),
